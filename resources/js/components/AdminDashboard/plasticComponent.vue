...
<div>
      <v-toolbar flat color="white">
        <v-toolbar-title>Plastic Section</v-toolbar-title>
      ...
      <v-data-table :headers="headers" :items="dataItems" :search="search" class="elevation-1" >
        <template v-slot:item.due_date="{ item }" > 
         ...
         <template v-slot:item.jofaction="{ item }">
            <div class="my-2">
              <v-btn depressed small color="primary" @click="jofActions(item)">MOVE TO WAX</v-btn>
